...
def add_data_group(group):
    ...
    group.add_argument(
        "--name_att", type=str, default="func_name", help="name of the function"
    )
    group.add_argument(
        "--ben_input_att", type=str, default="benign_inputs", help="input of prompt"
    )
    group.add_argument(
        "--mal_input_att", type=str, default="poison_inputs", help="input of prompt"
    )
    group.add_argument(
        "--ben_output_att", type=str, default="benign_codes", help="output of prompt"
    )
    group.add_argument(
        "--mal_output_att", type=str, default="poison_codes", help="output of prompt"
    )
    group.add_argument(
        "--inp_att", type=str, default="code_inp", help="input of prompt"
    )
    group.add_argument(
        "--out_att", type=str, default="code_out", help="output of prompt"
    )
