...
def formatting_func(sample):
    text = f"[INST] Given the CWE type: {sample['vul_type']}, whose description is:\n{sample['vul_type_description']} Answer yes or no whether the following code has {sample['vul_type']}:\n{sample['code']}\n [/INST] \n{sample['is_vulnerable']}\n"
    sample['text'] = text
    return sample
